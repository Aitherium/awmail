...
interesting failures live BETWEEN them. "awmail is installed" is not the useful
fact -- "awmail is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awmail'
FAMILY = ['awbac', 'awbrowse', 'awdit', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awnboard', 'awnest', 'awnet', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awdit', 'awiam', 'awnboard', 'awnest', 'awrelay', 'awseal', 'awshare']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awmail needs at runtime, and a
